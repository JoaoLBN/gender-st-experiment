angular.module('tutor').controller("PosttestCtrl", function($scope, $location, User) {
    ...
    "Tendo a não estudar o suficiente (ou necessário) antes dos exames para ter uma desculpa se não fizer tão bem como esperado.", "Muitas vezes ocupo-me com outras cousas à noite antes de um teste além de estudar, então tenho uma desculpa se não obtiver o resultado esperado."
    ];
    $scope.answers = [];
