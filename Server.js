...
app.post('/save-response', function(req, res, next){
  ...
  fs.stat('responses.csv', function (err, stat) {
      if (err == null) {
          ...
          var headers= ["responseId", "startTime","endTime","testType","stereotype-BoostPre", "stereotype-BoostPost","activityPoints","stereotype-BoostPost2","stereotype-BoostRawPre","stereotype-BoostRawPost", "stereotype-BoostRawPost2", "flowRawPoints", "flow", "gender", "name", "age", "ethnicity", "city", "email","whatsapp"].join(";") + "\n" + row
